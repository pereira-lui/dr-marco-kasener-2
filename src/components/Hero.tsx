...
const Hero = () => {
  return (
  <section className="relative flex min-h-screen items-center overflow-hidden pt-28 pb-16 sm:pt-32 sm:pb-20 lg:pt-0 lg:pb-0">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          {/* Text content */}
          <div className="order-2 animate-fade-in text-center lg:order-1 lg:text-left">
            <p className="text-primary text-sm md:text-base mb-4 tracking-wider uppercase">
              Medicina Estética
            </p>
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-normal mb-6 leading-tight">
              Naturalidade é o{" "}
              <span className="text-primary">novo luxo</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-xl leading-relaxed mx-auto lg:mx-0">
            ...
            <Button
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-8 mx-auto lg:mx-0"
